...
-- 1. Recriar função create_customer_account com search_path
...
-- 2. Recriar função recalculate_customer_account com search_path
...
-- 3. Recriar função update_account_on_sale_change com search_path
...
-- 4. Recriar função update_account_on_payment_change com search_path
